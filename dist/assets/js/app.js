...
_jquery2.default.ajax({
  ...
  success: function success(response) {
    ...
    (0, _jquery2.default)('.tabs-title').click(function () {
      var tabClicked = (0, _jquery2.default)(this).children('a').text();
      var tabHash = (0, _jquery2.default)(this).children('a').attr('href');
...
// reinit the tabs
var elem = new Foundation.Tabs((0, _jquery2.default)('#cities-tabs'));
...
function logResults(data) {
  ...
  for (var i in cities) {
    ...
    (0, _jquery2.default)('#cities-tabs').append('<li class="tabs-title"><a href="#' + cityHash + '">' + cities[i].city + '</a></li>');
    (0, _jquery2.default)('#cityContent').append('<div class="tabs-panel" id="' + cityHash + '">' + '<h1>' + cities[i].city + '</h1>' + '</div>');
    elem = new Foundation.Tabs((0, _jquery2.default)('#cities-tabs'));
  }
};
...
var _svgInjector = __webpack_require__(39);
